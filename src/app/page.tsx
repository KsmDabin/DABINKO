    ...
    <main className="min-h-screen p-8">
      ...
      <section className="max-w-4xl mx-auto mb-20">
        ...
        <p className="text-gray-700 mb-4">
          We supply humanoids and repair them along with their programs.
          Our programs, set up on your cell phone, allow you to control your humanoid remotely anytime and anywhere.
        </p>
      </section>
